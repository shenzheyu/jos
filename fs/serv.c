...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	// use file_read to read at most ipc->read.req_n bytes from the current seek position
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	// use file_write to write req->req_n bytes from req->req_buf to req_fileid
